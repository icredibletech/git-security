...
echo "API_BASE_URL=https://staging.api.file-security.icredible.com" >> $GITHUB_ENV
echo "MGMT_BASE_URL=https://staging.management.file-security.icredible.com" >> $GITHUB_ENV
